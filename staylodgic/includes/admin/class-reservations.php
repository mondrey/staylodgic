...
class Reservations {
	...
	/**
	 * Method get_guestfor_reservation
	 *
	 * @param $booking_number
	 *
	 * @return void
	 */
	public function get_guestfor_reservation( $booking_number ) {
		$args              = array(
			'post_type'      => 'slgc_reservations',
			'posts_per_page' => -1,
			'post_status'    => 'publish',
	...
	public function get_reservation_guest_name( $booking_number = false ) {
		...
		$customer_query = $this->get_guestfor_reservation( $booking_number );
	...
	public function is_room_for_the_day_fullybooked( $stay_room_id = false, $stay_date_string = false, $excluded_reservation_id = null ) {
		...
		$day                 = $stay_date_string;
		$reserved_room_count = $this->count_reservations_for_day( $room_id, $day, $excluded_reservation_id );
	...
	/**
	 * Method split_array_by_sontinuous_days
	 *
	 * @param $input_array $input_array [explicite description]
	 *
	 * @return void
	 */
	public function split_array_by_sontinuous_days( $input_array ) {
		$output_array = array();
	...
	public function availability_of_rooms_for_date_range( $checkin_date = false, $checkout_date = false, $limit = 10 ) {
		...
		$sub_set_room_availablity = self::split_array_by_sontinuous_days( $room_availablity );
