...
class Customers {
	...
	/**
	 * Method generate_customer_html_list
	 *
	 * @param $array
	 *
	 * @return void
	 */
	public static function generate_customer_html_list( $array ) {
	...
	public function get_room_names_by_customer( $customer_id ) {
		...
		foreach ( $posts as $post ) {
			...
			if ( ! empty( $room_id ) ) {
				...
				if ( $room_post && 'publish' === $room_post->post_status ) {
	...
	/**
	 * Method generate_customer_rooms
	 *
	 * @param $customer_id
	 *
	 * @return void
	 */
	public function generate_customer_rooms( $customer_id ) {
	...
	/**
	 * Method generate_customer_booking_numbers
	 *
	 * @param $customer_id
	 *
	 * @return void
	 */
	public function generate_customer_booking_numbers( $customer_id ) {
